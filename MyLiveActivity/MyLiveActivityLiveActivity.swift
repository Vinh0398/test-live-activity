...
struct MyLiveActivityLiveActivity_Previews: PreviewProvider {
    static let attributes = MyLiveActivityAttributes(name: "Me")
    static let contentState = MyLiveActivityAttributes.ContentState(value: 3)
